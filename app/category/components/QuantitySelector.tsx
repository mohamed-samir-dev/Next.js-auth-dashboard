  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button 
          onClick={onAddToCart}
          className="w-[234px] h-[56px] bg-[#BE968E] hover:bg-[#A8856B] text-white cursor-pointer font-medium rounded-[12px] flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
        >
